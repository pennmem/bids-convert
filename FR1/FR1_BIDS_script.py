...
converter = FR1_Bids(sys.argv[1], sys.argv[2], int(sys.argv[3]), float(sys.argv[4]), bool(int(sys.argv[5])), bool(int(sys.argv[6])), bool(int(sys.argv[7])), bool(int(sys.argv[8])))
converter.run()
