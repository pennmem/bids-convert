...
class catFR1_BIDS_converter(intracranial_BIDS_converter):
    ...
    # initialize
    def __init__(self, subject, experiment, session, system_version, unit_scale, monopolar, bipolar, mni, tal, area, root='/scratch/hherrema/BIDS_storage/catFR1/'):
    ...
    def set_wordpool(self):
        ...
        elif self.subject == 'R1039M' or self.subject == 'R1094T':
            wordpool_file = 'wordpools/wordpool_categorized_SP.txt'
        else:
            wordpool_file = 'n/a'
